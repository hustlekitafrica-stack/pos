...
export const PERMISSIONS = {
  ...
  viewAllOrders: ['admin', 'manager', 'cashier', 'bartender'] as Role[],
  requestShiftClosure: ['admin', 'manager', 'cashier', 'bartender', 'waiter'] as Role[],
  approveShiftClosure: ['admin', 'manager', 'cashier'] as Role[],
  closeShift: ['admin', 'manager', 'cashier', 'bartender'] as Role[],
